...
function apiModels(req, res) {
  ...
  const defaults = [
    { provider: 'deepseek', id: 'deepseek/deepseek-v4-flash-free', label: 'DeepSeek V4 Flash (free)' },
    ...
    { provider: 'openrouter', id: 'openrouter/anthropic/claude-opus-5', label: 'Claude Opus 5 (OR)' },
    { provider: 'openrouter', id: 'openrouter/anthropic/claude-haiku-4.5', label: 'Claude Haiku 4.5 (OR)' },
    { provider: 'openrouter', id: 'openrouter/openai/gpt-5.1', label: 'GPT-5.1 (OR)' },
