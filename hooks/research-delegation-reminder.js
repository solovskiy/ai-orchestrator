...
process.stdin.on('end', () => {
  ...
  const message = [
    ...
    'одним фоновым Bash-вызовом (run_in_background: true):',
    '  .ai/bin/agent delegate --task <slug> --repo <путь> \\',
    '    --capability research --prompt "<что изучить; сохрани отчёт в <файл>.md>"',
    'delegate сам дождётся и пришлёт уведомление о завершении.',
    '',
